execute @s[tag=host,scores={settings_state=1}] ~~~ scoreboard players set @s settings_warmup 1
execute @s[tag=host,scores={settings_state=1}] ~~~ tellraw @a {"rawtext":[{"text":"Turned §eon§f grace period."}]}
